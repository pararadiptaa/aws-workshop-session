...
const slides: SlideData[] = [
  ...
  { id: 8, title: "AWS Storage", subtitle: "Laptop Drive (EBS) vs Google Drive (EFS) vs Warehouse (S3).", visualId: "Storage" },
        ...
        {slides.map((slide, idx) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all duration-300 ${
              idx === currentIndex ? 'bg-accent scale-150' : 'bg-secondaryDepth hover:bg-depth'
            }`}
